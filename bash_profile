...
alias dgraph='docker run -it --cap-add=SYS_PTRACE --security-opt seccomp=unconfined --rm=true --memory=4g --publish=8010:8010 --volume=${HOME}:/home/admin --workdir=/home/admin/github/graph_embedding reg.docker.alibaba-inc.com/graph_embeding/graphsage:dev /bin/bash'
